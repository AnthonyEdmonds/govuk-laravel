...
| mail.header.logo        | string | null          | An asset path, route, or URL for the header logo              |
...
| mail.footer.logo        | string | null          | An asset path, route, or URL for the footer logo              |
